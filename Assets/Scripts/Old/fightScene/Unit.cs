...
public class Unit : MonoBehaviour
{
    ...
    public void SetValues()
    {
        ...
        CountExp();
        int baseRang;
        if (rang.Id == 0) baseRang = 75;
        else if (rang.Id == 1) baseRang = 100;
        else if (rang.Id == 2) baseRang = 125;
        else baseRang = 150;
    ...
    public void CountExp()
    {
        ...
        if (rang.Id == 0) expNeed = Convert.ToInt32(expNeedTemp / 1.75f);
        else if (rang.Id == 1) expNeed = Convert.ToInt32(expNeedTemp / 1.5f);
        else if (rang.Id == 2) expNeed = Convert.ToInt32(expNeedTemp / 1.25f);
        else if (rang.Id == 3) expNeed = Convert.ToInt32(expNeedTemp / 1f);
    }
}
