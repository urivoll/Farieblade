...
{
    public static CirclesProperties[,] circlesMap = new CirclesProperties[2, 6];
    public static CirclesProperties[] circleAll;
    ...
    public static List<CirclesProperties> listFinishRight = new();
    ...
    [SerializeField] private CirclesProperties[] circleAllPrefub;
    [SerializeField] private CirclesProperties[] circleLeftPrefub;
    [SerializeField] private CirclesProperties[] circleRightPrefub;
    ...
    private IEnumerator BeforeTurn()
    {
        ...
        while (true)
        {
            ...
            if (turnUnit != null && !turnUnit.paralize && turnUnit.pathParent.fraction.Id != 9)
            {
